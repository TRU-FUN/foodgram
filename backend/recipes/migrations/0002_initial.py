...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='recipe',
            name='shopping_cart_entries',
            field=models.ManyToManyField(related_name='shopping_cart', through='recipes.ShoppingCart', to=settings.AUTH_USER_MODEL, verbose_name='В списках покупок'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='tags',
